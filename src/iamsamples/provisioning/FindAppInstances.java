...
public class FindAppInstances {
    ...
    public static void main(String[] args) throws Exception {
        ...
        */
        ...
        //ApplicationInstance ai = aiSvc.findApplicationInstanceByName("SecondOUDInstance"); 
        ApplicationInstance ai = aiSvc.findApplicationInstanceByName("EnterpriseDirectoryOUD");
